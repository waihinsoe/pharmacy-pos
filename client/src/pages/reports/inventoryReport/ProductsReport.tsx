...
import { useProductsReport } from "../../../hooks/InventoryReport/useInventoryReport";
...
export const ProductsReport = ({ chart, query }: Props) => {
  const { token } = useAuth();

  const { data, isLoading } = useProductsReport(token || "", query);
